...
[^repeating]: The system developed to repeating someone else's repression (against an Equal) and changing one facet of it (double, divide, and deconstruct herd mentality). The repetition helps disguise the original act. Today they have developed to have the appearance of being meritorious/ethical (e.g. "working out"...).
