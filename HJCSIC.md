...
The first group becomes so rewarded that they draw the ire of the second group. The confusion-magnetization/spellboundness/misdirection lulls them into being spoon-fed what the rewards are. The rewards come silently from the Jews and are done largely by discriminating against the third group using the Hebrew Code.
