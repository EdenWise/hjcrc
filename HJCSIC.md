...
Their complicity with sin (against nature) has gotten the second group "saved"/inclusion.


 From the confusion the Jews are able to secretly spoon-feed what the rewards are. The rewards (inclusion) go to those who become desperate and react selfishly ~~(drol and dog)~~. 
