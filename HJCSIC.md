*To be a citizen the best thing to fear is myself. Free has been made available in most of our lives that will tend us to power through our sexual disposition.* | *Civilization is only good behavior.*

# How the Judeo-Christian System Influences Civilization (Part 1) http://tinyurl.com/HJCR1 https://bit.ly/HJCSIC


![](images/05_ages-of-civilization_eden.svg)![](images/10_eras-of-heaven.svg)Civilization began as a natural order. When the Judeo-Christin system started this all changed. Civilization moved from communal evolution to personal salvation through joining a secret, predesigned system---those that know the details of the system get the rewards. It was started long ago by male dominion (dynasties [rewarding the most fortunate]), secreted by the Jews, and has become the social consruct of the world. The Jews implement the system by rewarding reaping acts for fifty years (i.e. taking; it largely affects men). The reapers, the Jews, the first group, the political left become so rewarded, so hard to deal with, that they draw the suspicion and anger of a second group (their wives...). To deal with the resistance the Jews reward sowing acts for the next fifty years (making things grow, giving; it largely affects women and their protected). The entire system is kept silent through all of time. By the silence, alternating support, and occasional antagonism much confusion is caused to the second group. So much so that many in the second group can call an all-out war against the first group. The general frustration of the second group though stimulates the Jews and allows them to make the second group (mostly ignorantly) complicit. They get complicity by: the anger directing focus away from the people that need it most (the third group, the people with little knowledge of the first group, or who are intentionally left behind); rewarding the second group when they discriminate against the third group by how they use the Hebrew Code (the political rights understanding of the Hebrew Code is sparse and often incorrect); by getting the right to keep the system largely silent; and others... 

The complicity with sin (against nature) has gotten the second group "saved".

That is they have got the second group to sin (betray nature) by getting them to sepearate from the third group (the people with little knowledge of the first group, or who are intentionally left behind). They do this by: one, getting the second group angry and directing the focus away from the people that need the help; and two, making the second group discriminate by rewarding them when they guess the Hebrew Code incorrectly.

 ~~The "Secret of Heaven"~~ leads them to push on civilization a dualistic system (primary/secondary, male/female, reap/sow...).

 From the confusion the Jews are able to secretly spoon-feed what the rewards are. The rewards (inclusion) go to those who become desperate and react selfishly ~~(drol and dog)~~. It hurts those in the third group, the people ignorant or with little knowledge of the first group. It usually involves using the Hebrew Code to declassify/discriminate with.
