...
The research for this paper is generally from the Bible. The Bible, the most read book in the world, is where the Judeo-Christian system documents its intent. Institutions that have been around awhile usually provide a plan and both the Jews and the Christians have described their plans in their Testaments. So profitable with their system, the Jews have become very secretive and have spent much time refining the Bible. The Bible has many devices and its attitude can be intimidating. The audaciousness and graphicness can contain meanings for those more removed from mortal feelings. It is meant to be understood by those who have supernatural safety. When, though, one understands the intent of the Bible (the most read book in the world) it helps decipher how this system influences civilization. Those that are a part of the system would like to say that the Testaments are **fair** declarations with civilization. However, to say it is a sufficient declaration is false. Because the Bible only tells part of the "Secret of Heaven", is intentionally cryptic, and uses graphicness to portray conent it fails that standard[^Judeo-Christian-Definition]. A couple of things to know: The Bible is written revisionistically[^definition-revisionistic](backwritten) to make newer rules apply throughout, the beginning of the Bible is packed with details, and the Bible ~~is the beginning of the rebellion,~~ the female side of the story (except for Genesis 1), the story of growing male sacrifices (*it will be a while before I get that*).
