...
![](images/05_ages-of-civilization_eden.svg)![](images/10_eras-of-heaven.svg)Civilization began as a natural order. When the Judeo-Christin system started this all changed. Civilization moved from communal evolution to personal salvation through joining a secret, predesigned system. (Those that know the details of the system get the rewards.) It was started long ago by male dominion (dynasties---rewarding the most fortunate) and secreted by the Jews. ~~The system has become the social consruct.~~ The Jews implement the system by rewarding reaping acts for the first fifty years (i.e. taking; it largely affects men). The reapers (the Jews, the first group, the political left) become so rewarded that they draw the suspicion and ire of some people (their wives...). To deal with the resistance the Jews reward sowing acts for the next fifty years (making things grow, giving; it largely affects women and their protected). The entire system is kept silent through all of time. By the first group's silence, alternating support, and occasional antagonism much confusion is caused to the second group. So much so that many in the second group have nearly called an all-out war against them. The confusion and anger allow the Jews to make the second group complicit. That is they have got the second group to sin (betray nature) by getting them to sepearate from the third group (the people with little knowledge of the first group, or who are intentionally left behind). They do this by: one, getting the second group angry and directing the focus away from the people that need the help; and two, making the second group discriminate by rewarding them when they guess the Hebrew Code incorrectly.
