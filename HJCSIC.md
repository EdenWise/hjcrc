...
![](images/05_ages-of-civilization_eden.svg)![](images/10_eras-of-heaven.svg)Civilization began as a natural order. When the Judeo-Christin system started this all changed. Civilization moved from communal evolution to personal salvation through joining a secret, predesigned system---those that know the details of the system get the rewards. It was started by male dominion long ago (dynasties [rewarding the most fortunate]), secreted by the Jews, and is now the social consruct of the world. The Jews implement the system by rewarding reaping acts for fifty years (i.e. taking; it largely affects men). The reapers, the Jews, the first group, the political left become so rewarded, so hard to deal with, that they draw the suspicion and anger of a second group (their wives..., the political right). To deal with the resistance the Jews reward sowing acts for the next fifty years (making things grow, giving; it largely affects women and their protected). The entire system is kept silent through all of time. By the silence, alternating support, and occasional antagonism much confusion is caused to the second group. So much so that many in the second group can call an all-out war against the first group. The general frustration of the second group though stimulates the Jews to make the second group become complicit (though these days the political right would claim ignorance). The Jews get complicity by: one, causing the anger that directs focus away from the people that need it most (the third group, the people with little knowledge of the first group, or who are intentionally left behind); two, rewarding the second group when they discriminate against the third group by how they use the Hebrew Code (the political right understands the Hebrew Code sparsely and often incorrectly); three, by getting the right to keep the system largely silent; amoungst others... By sin (against nature) the political right has got **inclusion** for the second group or got them "saved".
