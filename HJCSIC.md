...
![](images/05_ages-of-civilization_eden.svg)![](images/10_eras-of-heaven.svg)Civilization began as a natural order. When the Judeo-Christin system started it upset the entire order. Civilization moved from communal evolution to personal salvation through joining a secret, predesigned system---those that know the details of the system get the rewards. It started with male dominion (dynasties [rewarding the most fortunate]) long ago, and got secreted by the Jews. Today the system has spread to become the social construct of the world. It is implemented by the Jews by rewarding reaping acts for the first fifty years (i.e. taking, usually men). The reapers (the Jews, the first group, the political left) become so rewarded, so immobile in their thinking, that they draw the hostility of a second group of people (their wives, more fortunate men...). To deal with the resistance the Jews reward sowing acts for the next fifty years (making things grow, giving; it largely affects women and their protected, the political right). The entire system is kept silent through all of time. By the silence, alternating support, and occasional antagonism much confusion is caused to the second group. So much confusion is created that many in the **second group/political right** can call an all-out war against the first group. The general frustration of the second group though stimulates the Jews to make the second group become complicit (though these days the political right would claim ignorance). The Jews get complicity by: one, causing the anger that directs focus away from the people that need it most (the third group, the people with little knowledge of the first group, or who are intentionally left behind); two, rewarding the second group when they discriminate against the third group by how they use the Hebrew Code (the political right understands the Hebrew Code sparsely and often incorrectly); three, by getting the right to keep the system largely silent; amoungst others... By sin (against nature) the political right has got **inclusion** for the second group or got them "saved".
